...
bool FPinLink::HasBothGraphPins(TSharedPtr<SGraphPanel> GraphPanel) const
{
	return FBAUtils::GetGraphPinFast(GraphPanel, GetFromPinUnsafe()) && FBAUtils::GetGraphPinFast(GraphPanel, GetToPinUnsafe());
}
