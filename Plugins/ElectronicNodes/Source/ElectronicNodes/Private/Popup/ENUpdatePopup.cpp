...
void ENUpdatePopup::Register()
{
    ...
    const FString CurrentPluginVersion = "3.20";
...
void ENUpdatePopup::Open()
{
	...
	TSharedRef<SVerticalBox> InnerContent = SNew(SVerticalBox)
		...
		[
			SNew(STextBlock)
			.Font(HeadingFont)
			.Text(FText::FromString("Electronic Nodes v3.20"))
		]
		+ SVerticalBox::Slot()
		.FillHeight(1.0)
		.Padding(10)
...
I also made a marketplace search engine called <a id="browser" href="https://orbital-market.com">Orbital Market</>. It's completely free, super fast and full of filters to refine your search.

But let's keep it short, here are the cool new features (and bugfixes) of version 3.20!
...
<LargeText>Version 3.17</>

<RichTextBlock.Bold>Bugfixes</>

* Fix slice line (<a id="browser" href="https://github.com/hugoattal/ElectronicNodes/issues/108">issue #108</>)
